...
public class MyBinaryJedisCluster implements BasicCommands, BinaryJedisClusterCommands,
		MultiKeyBinaryJedisClusterCommands, JedisClusterBinaryScriptingCommands, Closeable, JedisCommands,
	...
	protected MyJedisSlotBasedConnectionHandler connectionHandler;

	public MyBinaryJedisCluster(Set<HostAndPort> nodes, int timeout) {
		this(nodes, timeout, DEFAULT_MAX_REDIRECTIONS, new GenericObjectPoolConfig());
	}

	public MyBinaryJedisCluster(Set<HostAndPort> nodes) {
		this(nodes, DEFAULT_TIMEOUT);
	}

	public MyBinaryJedisCluster(Set<HostAndPort> jedisClusterNode, int timeout, int maxAttempts,
			final GenericObjectPoolConfig poolConfig) {
		this.connectionHandler = new MyJedisSlotBasedConnectionHandler(jedisClusterNode, poolConfig, timeout);
		this.maxAttempts = maxAttempts;
	}

	public MyBinaryJedisCluster(Set<HostAndPort> jedisClusterNode, int connectionTimeout, int soTimeout,
			int maxAttempts, final GenericObjectPoolConfig poolConfig) {
		this.connectionHandler = new MyJedisSlotBasedConnectionHandler(jedisClusterNode, poolConfig, connectionTimeout,
				soTimeout);
		this.maxAttempts = maxAttempts;
	}
	...
	public String set(final byte[] key, final byte[] value) {
		return new MyJedisClusterCommand<String>(connectionHandler, maxAttempts) {
			@Override
	...
	public byte[] get(final byte[] key) {
		return new MyJedisClusterCommand<byte[]>(connectionHandler, maxAttempts) {
			@Override
	...
	public Boolean exists(final byte[] key) {
		return new MyJedisClusterCommand<Boolean>(connectionHandler, maxAttempts) {
			@Override
	...
	public Long exists(final byte[]... keys) {
		return new MyJedisClusterCommand<Long>(connectionHandler, maxAttempts) {
			@Override
	...
	public Double incrByFloat(final byte[] key, final double value) {
		return new MyJedisClusterCommand<Double>(connectionHandler, maxAttempts) {
			@Override
	...
	public List<byte[]> hmget(final byte[] key, final byte[]... fields) {
		return new MyJedisClusterCommand<List<byte[]>>(connectionHandler, maxAttempts) {
			@Override
	...
	public Set<byte[]> hkeys(final byte[] key) {
		return new MyJedisClusterCommand<Set<byte[]>>(connectionHandler, maxAttempts) {
			@Override
	...
	public Collection<byte[]> hvals(final byte[] key) {
		return new MyJedisClusterCommand<Collection<byte[]>>(connectionHandler, maxAttempts) {
			@Override
	...
	public Map<byte[], byte[]> hgetAll(final byte[] key) {
		return new MyJedisClusterCommand<Map<byte[], byte[]>>(connectionHandler, maxAttempts) {
			@Override
	...
	public Set<Tuple> zrangeWithScores(final byte[] key, final long start, final long end) {
		return new MyJedisClusterCommand<Set<Tuple>>(connectionHandler, maxAttempts) {
			@Override
	...
	public Object eval(final byte[] script, final byte[] keyCount, final byte[]... params) {
		return new MyJedisClusterCommand<Object>(connectionHandler, maxAttempts) {
			@Override
	...
	public List<Long> scriptExists(final byte[] key, final byte[][] sha1) {
		return new MyJedisClusterCommand<List<Long>>(connectionHandler, maxAttempts) {
			@Override
	...
	public void subscribe(final BinaryJedisPubSub jedisPubSub, final byte[]... channels) {
		new MyJedisClusterCommand<Integer>(connectionHandler, maxAttempts) {
			@Override
	 ...
	 *             Redis Cluster only uses db index 0 scheduled to be removed on
	 *             next major release
	 */
	@Deprecated
	@Override
	...
	/**
	 * @deprecated No key operation doesn't make sense for Redis Cluster and
	 *             Redis Cluster doesn't support authorization scheduled to be
	...
	public List<GeoCoordinate> geopos(final byte[] key, final byte[]... members) {
		return new MyJedisClusterCommand<List<GeoCoordinate>>(connectionHandler, maxAttempts) {
			@Override
	...
	public List<GeoRadiusResponse> georadius(final byte[] key, final double longitude, final double latitude,
		...
		return new MyJedisClusterCommand<List<GeoRadiusResponse>>(connectionHandler, maxAttempts) {
			@Override
	...
	public ScanResult<byte[]> scan(final byte[] cursor, final ScanParams params) {
		...
		if (JedisClusterHashTagUtil.isClusterCompliantMatchPattern(matchPattern)) {
			...
			return new MyJedisClusterCommand<ScanResult<byte[]>>(connectionHandler, maxAttempts) {
				@Override
	...
	public ScanResult<Map.Entry<byte[], byte[]>> hscan(final byte[] key, final byte[] cursor) {
		return new MyJedisClusterCommand<ScanResult<Map.Entry<byte[], byte[]>>>(connectionHandler, maxAttempts) {
			@Override
	...
	public ScanResult<Tuple> zscan(final byte[] key, final byte[] cursor) {
		return new MyJedisClusterCommand<ScanResult<Tuple>>(connectionHandler, maxAttempts) {
			@Override
	...
	public String get(final String key) {
		return new MyJedisClusterCommand<String>(connectionHandler, maxAttempts, true) {
			@Override
			public String execute(Jedis connection) {
				return connection.get(key);
			}
	...
	public List<String> hmget(final String key, final String... fields) {
		return new MyJedisClusterCommand<List<String>>(connectionHandler, maxAttempts) {
			@Override
	...
	public Set<String> hkeys(final String key) {
		return new MyJedisClusterCommand<Set<String>>(connectionHandler, maxAttempts) {
			@Override
	...
	public Map<String, String> hgetAll(final String key) {
		return new MyJedisClusterCommand<Map<String, String>>(connectionHandler, maxAttempts) {
			@Override
	...
	public ScanResult<String> scan(final String cursor, final ScanParams params) {
		...
		if (JedisClusterHashTagUtil.isClusterCompliantMatchPattern(matchPattern)) {
			...
			return new MyJedisClusterCommand<ScanResult<String>>(connectionHandler, maxAttempts) {
				@Override
	...
	public ScanResult<Entry<String, String>> hscan(final String key, final String cursor) {
		return new MyJedisClusterCommand<ScanResult<Entry<String, String>>>(connectionHandler, maxAttempts) {
			@Override
	...
	public List<Boolean> scriptExists(final String key, final String... sha1) {
		return new MyJedisClusterCommand<List<Boolean>>(connectionHandler, maxAttempts) {
			@Override
