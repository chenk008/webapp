...
public abstract class MyJedisClusterCommand<T> {

	private MyJedisSlotBasedConnectionHandler connectionHandler;
	private int maxAttempts;
	private ThreadLocal<Jedis> askConnection = new ThreadLocal<Jedis>();
	private boolean isRead = false;

	public MyJedisClusterCommand(MyJedisSlotBasedConnectionHandler connectionHandler, int maxAttempts) {
		this.connectionHandler = connectionHandler;
		this.maxAttempts = maxAttempts;
	}

	public MyJedisClusterCommand(MyJedisSlotBasedConnectionHandler connectionHandler, int maxAttempts, boolean isRead) {
		this.connectionHandler = connectionHandler;
		this.maxAttempts = maxAttempts;
		this.isRead = isRead;
	}
